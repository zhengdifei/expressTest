ModelMap = {
	...
	'T_BASE_FIELD.selectById' : {'sql':'SELECT A.ZDMC,A.ZDLX,A.ZDCD,A.SFZJ,A.SFWK,A.MRZ,A.ZDZS FROM T_BASE_FIELD A WHERE A.ZDID = #ZDID#',
		'before' : ['../Interceptor/FieldSelectInterceptor','../Interceptor/FieldInsertInterceptor'],
		'after' : ['../Interceptor/FieldSelectInterceptor','../Interceptor/FieldInsertInterceptor']},
